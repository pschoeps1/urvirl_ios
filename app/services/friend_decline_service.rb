class FriendDeclineService
  ...
  def initialize client, options
    ...
    @url = "http://mighty-mesa-2159.herokuapp.com/v1/friendships/#{id}/decline?auth_token=#{auth_token}&friend_id=#{friend_id}"
  end
  ...
  def handle_response response
    ...
    method =  case response.status_code
                when 401 || 500..599
                  :handle_friend_decline_failed
                when 200..299
                  :handle_friend_decline_successful
              end
